    ...
    if(isset($_POST["submit"])){
        if(isset($_POST['allow'])){
            ...
            foreach($allowed as $id){
                mysqli_query($conn,"update user set date= curdate(), status='granted' where user_id=$id");
        ...
        <div class="container">
            ...
            <div class="responsive-table">
                <table class="table table-striped text-center" id="teacher-table">
                    ...
                    $res = mysqli_query($conn,"select name,email,mobile,user_id from user where status='pending'");
