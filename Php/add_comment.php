<?php 
    ...
    if(isset($_POST["submit"])){
        ...
        $user_id = $_SESSION["id"];
        mysqli_query($conn,"insert into comment values ('$content',$user_id,curdate(),$post_id)") or die(mysqli_error($conn));
    }
?>
...
END;
        ...
        ?>
            ...
            <a class="list-group-item list-group-item-action flex-column align-items-start">
                <form method="post">
                    <div class="d-flex w-100 justify-content-between">
                        <input style="width:78%" type="text" placeholder="Enter comment" name="content">
